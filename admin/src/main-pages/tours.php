        ...
        <div class="col-sm-12 col-md-5 col-lg-4">
          <div class="card">
            <div class="box-offer-img-wrap">
              <a href="#">
                <img class="img-fluid"
                     src="http://natoura.am/wp-content/uploads/2016/01/12788793_10208836140524540_1134342321_o-400x260.jpg"
                     alt="Denim Jeans">
              </a>
            </div>
            <div class="box-offer-caption p-3">
        ...
        <div class="col-sm-12 col-md-5 col-lg-4">
          <div class="card">
            <div class="box-offer-img-wrap">
              <a href="#">
                <img class="img-fluid"
                     src="http://natoura.am/wp-content/uploads/2015/04/DSC08920-400x260.jpg"
                     alt="Denim Jeans">
              </a>
            </div>
            <div class="box-offer-caption p-3">
